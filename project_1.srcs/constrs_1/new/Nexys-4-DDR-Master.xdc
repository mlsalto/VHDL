...
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { switches_colors[0] }]; #IO_L24N_T3_RS0_15 Sch=sw[0] --AZUL & VALUE 
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { switches_colors[1] }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=sw[1]  --GREEN & SATURATION
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { switches_colors[2] }]; #IO_L6N_T0_D08_VREF_14 Sch=sw[2] --ROJO & HUE
...
set_property -dict { PACKAGE_PIN R12 IOSTANDARD LVCMOS33 } [get_ports { led_rgb[1]}]; #IO_L5P_T0_D06_14 Sch=led16_b AZUL
set_property -dict { PACKAGE_PIN M16   IOSTANDARD LVCMOS33 } [get_ports { led_rgb[0] }]; #IO_L10P_T1_D14_14 Sch=led16_g VERDE
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { led_rgb[2] }]; #IO_L11P_T1_SRCC_14 Sch=led16_r ROJO
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { led_rgb_comp[1] }]; #IO_L15N_T2_DQS_ADV_B_15 Sch=led17_b AZUL COMP
set_property -dict { PACKAGE_PIN R11   IOSTANDARD LVCMOS33 } [get_ports { led_rgb_comp[0] }]; #IO_0_14 Sch=led17_g
set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 } [get_ports { led_rgb_comp[2] }]; #IO_L11N_T1_SRCC_14 Sch=led17_r 
...
set_property -dict { PACKAGE_PIN N17    IOSTANDARD LVCMOS33} [get_ports button[1]]
